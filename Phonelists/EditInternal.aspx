<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditInternal.aspx.cs" Inherits="EditInternal" %>
...
<head id="Head1" runat="server">
    ...
    function filterDigits(eventInstance) {
        ...
        //alert(key);
        if ((47 <= key) && (key <= 58) || (97 <= key) && (key <= 122) || (65 <= key) && (key <= 90) || key == 46 || key == 64 || key == 32 || key == 35 || key == 45 || key == 8) {
            return true;
        }
        else {
    ...
    <form id="form1" runat="server" style="width:100%">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="2"
            ...
            OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" 
                Width="100%" onrowdatabound="GridView1_RowDataBound" onkeypress="filterDigits(event);">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Department">
                    <EditItemTemplate>
                        <asp:Label ID="lblStatusValue" runat="server" Visible="false" Text='<%# Bind("Dept_Number") %>'></asp:Label>
                        <asp:SqlDataSource ID="sqlDepts" runat="server" ConnectionString="<%$ ConnectionStrings:WebSqlServer %>" 
                        SelectCommand="SELECT RTRIM([Dept]) AS Dept,RTRIM([Dept_Number]) AS Dept_Number FROM [PhoneList].[dbo].[Department] ORDER BY Dept ASC"></asp:SqlDataSource>
                        <asp:DropDownList ID="ddlDepts" runat="server" DataSourceID="sqlDepts" DataTextField="Dept" DataValueField="Dept_Number" ></asp:DropDownList>
                    </EditItemTemplate>
                    <ItemTemplate>
                ...
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Email" HeaderText="Email" />
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Work_mob" HeaderText="Work Mob" />
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Work_mobSC" HeaderText="Work MobSC" />
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Home_Phone" HeaderText="Home Phone" />
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Home_PhoneSC" HeaderText="Home PhoneSC" />
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Home_mob" HeaderText="Home Mob" />
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Home_mobSC" HeaderText="Home MobSC" />
