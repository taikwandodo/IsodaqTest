<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Other.aspx.cs" Inherits="phonelist_Other" %>
...
<body>
    <form id="form1" runat="server" style="width:100%">
        ...
        <h3 style="color:#284775">Phone List - Offices</h3>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="3" ForeColor="#333333" GridLines="Both" AllowSorting="true" onrowdatabound="GridView1_RowDataBound" onsorting="GridView1_Sorting" Width="100%">
            <Columns>
                <asp:BoundField SortExpression="Fullname" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Fullname" HeaderText="Name" />
        ...
        <tr>
            ...
            <h3 style="color:#284775">Phone List - Other</h3>
        <label style=" color:#5D7B9D; font-size: small">Sort columns by clicking on headers</label>
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="3" ForeColor="#333333" GridLines="Both" AllowSorting="true" onrowdatabound="GridView2_RowDataBound" onsorting="GridView2_Sorting" Width="100%">
            <Columns>
                <asp:BoundField SortExpression="Fullname" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Fullname" HeaderText="Name" />
                <asp:BoundField SortExpression="Phone" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Phone" HeaderText="Phone Number" />
        ...
        <tr>
            <td align="left">
                <asp:LinkButton runat="server" ID="LinkButton2" onclick="LinkButton2_Click">Edit list</asp:LinkButton>
            </td>
            <td align="right">
                <asp:Label ID="Label4" style="font-style:italic;font-size:small;" runat="server" Text="export results to Excel"></asp:Label>
                <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="images/excel.gif" ToolTip="Export results to Excel" onclick="btnExportToExcel1_Click" />
            </td>
        </tr>
        </table>
    </div>
