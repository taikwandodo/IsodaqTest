<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Department.aspx.cs" Inherits="phonelist_Department" %>
...
<body>
    <form id="form1" runat="server" style="width:100%">
        ...
        <h3 style="color:#284775">Phone List - Departments</h3>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="3" ForeColor="#333333" GridLines="Both" onrowdatabound="GridView1_RowDataBound" onsorting="GridView1_Sorting" Width="100%">
            <Columns>
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="First_name" HeaderText="Firstname" />
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Last_name" HeaderText="Surname" />
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Office" HeaderText="Office" />
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Mobile" HeaderText="Mobile" />
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Home" HeaderText="Home" />
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="HomeMobile" HeaderText="Home Mobile" />
