<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditExternal.aspx.cs" Inherits="EditExternal" %>
...
<head id="Head1" runat="server">
    ...
    function filterDigits(eventInstance) {
        ...
        //alert(key);
        if ((47 <= key) && (key <= 58) || (97 <= key) && (key <= 122) || (65 <= key) && (key <= 90) || key == 64 || key == 46 || key == 32 || key == 35 || key == 45 || key == 8) {
            return true;
        }
        else {
    ...
    <form id="form1" runat="server" style="width:100%">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="2"
            ...
            <Columns>
                ...
                <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" DataField="Fullname" HeaderText="Company Name" />
        ...
        <br />
            ...
            <tr>
                <td align="left">
                    <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="Add new number" Visible="false" style="color:#284775; font-weight:normal;" />
                </td>
                <td align="right">
                    &nbsp;
                </td>
